  ...
  const fetchProfile = async () => {
    try {
      ...
      Toast.show({
        ...
        text1: "Erişim Hatası",
        text2:
          "Profil bilgileri alınamadı. Lütfen internet bağlantınızı kontrol ediniz.",
      });
    } finally {
      setLoading(false);
    }
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const errorMsg =
        error?.response?.data ||
        error?.message ||
        "Değişiklikler kaydedilemedi, tekrar deneyiniz.";
      Toast.show({
        type: "error",
        text1: "Uyarı",
        text2: typeof errorMsg === "string" ? errorMsg : "Bir sorun oluştu.",
      });
    }
  };
          ...
          onPress: async () => {
            try {
              ...
              Toast.show({
                type: "success",
                text1: "Hesap Silindi",
                text2: "UniVibe hesabınız kapatılmıştır.",
              });
              router.replace("/(auth)/login");
            } catch (error) {
              Toast.show({
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F3F4F6" }}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.btnContainer}>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { borderColor: "#FEE2E2", marginTop: 10 }]}
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.fieldGroup}>
                  ...
                  <Text style={styles.warningText}>
                    * Kullanıcı adınızı güncelledikten sonra 30 gün boyunca
                    tekrar değiştiremezsiniz.
                  </Text>
                </View>
                ...
                <View style={styles.fieldGroup}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditForm({ ...editForm, socialMediaLink: text })
                    }
                  />
                </View>
              </ScrollView>
